  ...
  <body style="height: 100vh; width: 100vw">
    ...
    <form action="../api/validate_search.php" method="GET">
      <div style="width: 15%; right: 10%; position: absolute;" class="mt-4">
        <input type="text" class="form-control" id="search" name="search_query" required>
      </div>
    </form>

    <?php if($order_id == null) {
      echo "<p style=\"text-align: center\" class=\"fs-3 my-4\">Sorry, no results were found for: </p>" . '<p style="text-align: center; overflow-wrap: break-word;" class="fs-3">' . htmlspecialchars($o_id) . "</p>";
    } 
    else{
